...
public class CSS1Question extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CSS1Helper db = new CSS1Helper(this);  // Mi clase de banco de preguntas
    ...
    public void getAnswer(String AnswerString) {
        ...
        if (qid < 20) {
            ...
            helper.actualizarBloqueo(2);
            Intent intent = new Intent(CSS1Question.this,
