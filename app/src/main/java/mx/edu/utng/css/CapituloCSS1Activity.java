...
import mx.edu.utng.css.examen.css2.CSS2Question;

/**
 * Created by MD on 06/02/2016.
 */
public class CapituloCSS1Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        texto.setText(R.string.css2);//toda la informacion del tema
        ...
        imagen.setBackgroundResource(R.drawable.imag20);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.itm_menu_bar_desarrollador:
                ...
                intent=new Intent(CapituloCSS1Activity.this,DesarrolladorActivity.class);
            ...
            case R.id.itm_menu_bar_Tema:
                startActivity(new Intent(CapituloCSS1Activity.this, TemaActivity.class));
                break;
            case R.id.itm_menu_bar_correo:
                startActivity(new Intent(CapituloCSS1Activity.this, MailActivity.class));
                break;
            case R.id.itm_menu_bar_grafica:
                startActivity(new Intent(CapituloCSS1Activity.this, GraficaMenuActiviry.class));
                break;
            case R.id.itm_menu_bar_juegos:
                startActivity(new Intent(CapituloCSS1Activity.this, Manager.class));
                break;
            case R.id.itm_menu_bar_galery:
                startActivity(new Intent(CapituloCSS1Activity.this, GaleriasActivity.class));
                break;
            case R.id.itm_menu_bar_tools:
                startActivity(new Intent(CapituloCSS1Activity.this, UtileriasActivity.class));
                break;
            case R.id.itm_menu_bar_streaming:
                startActivity(new Intent(CapituloCSS1Activity.this, StreamingMp3Player.class));
                break;
            case R.id.itm_menu_bar_maps:
                startActivity(new Intent(CapituloCSS1Activity.this, MapsActivity.class));
                break;
            default:
                break;
        }
                    ...
                    new AlertDialog.Builder(this)
                            ...
                            .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    Intent i = new Intent(CapituloCSS1Activity.this, CSS2Question.class).putExtra("logeo",bundleResividos.getBoolean("logeo"));
                                    startActivity(i);
                                }
                            }).show();
